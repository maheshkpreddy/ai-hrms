...
export const config = {
  matcher: [
     ...
     */
    '/((?!api/auth|api/public|api/health|api/ai-interview|api/db-init|api/companies|api/setup|api/migrate|api/reseed|api/seed|api/migrate-schema|api/check-schema|api/debug-auth|api/test-auth|api/auth-logs|_next/static|_next/image|favicon.ico|logo.svg|login|mobile-app|job-portal|interview|manifest.webmanifest|sw.js|robots.txt).*)',
  ],
}
