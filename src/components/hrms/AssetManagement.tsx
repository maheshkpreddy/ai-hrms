...
export default function AssetManagement() {
  ...
  // Internal tab synced from sidebar sub-item selections
  // Mapping: 'asset-list' → Asset Inventory | 'assign-asset' → Assign Assets | 'asset-requests' → Requests
  const [activeTab, setActiveTab] = useState<'asset-list' | 'assign-asset' | 'asset-requests'>('asset-list')

  // Sync sidebar sub-item to internal tab
  useEffect(() => {
    if (activeSubItem && ['asset-list', 'assign-asset', 'asset-requests'].includes(activeSubItem)) {
      setActiveTab(activeSubItem as 'asset-list' | 'assign-asset' | 'asset-requests')
      // Auto-open the Add Asset dialog when 'assign-asset' sub-item is clicked
